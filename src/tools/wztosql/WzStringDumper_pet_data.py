"""
WzStringDumper宠物数据 - 从Java源文件转换而来
对应Java源文件: tools/wztosql/WzStringDumper宠物数据.java
包路径: tools.wztosql
"""
...
class WzStringDumperPetData:
    """
    Class WzStringDumperPetData - converted from Java
    """
