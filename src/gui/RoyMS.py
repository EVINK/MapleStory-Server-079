"""
RoyMS - Converted from Java source
Original: gui/RoyMS.java
Package: gui
"""
...
class RoyMS(JFrame):
    ...
    def initComponents(self) -> None:
        ...
        self.jButton7.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jButton7ActionPerformed(evt)
        self.jButton8.setText("保存雇佣")
        self.jButton8.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jButton8ActionPerformed(evt)
        ...
        self.jTextField2.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jTextField2ActionPerformed(evt)
        self.jButton13.setText("公告发布")
        self.jButton13.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jButton13ActionPerformed(evt)
        ...
        self.jButton14.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jButton14ActionPerformed(evt)
        ...
        self.jTextField20.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jTextField20ActionPerformed(evt)
        ...
        self.jButton15.addActionListener(ActionListener()
            public void actionPerformed(final ActionEvent evt)
                RoyMS.self.jButton15ActionPerformed(evt)
    ...
    def jButton10ActionPerformed(self, evt: Any) -> None:
        try:
            ...
            Logger.getLogger(RoyMS.class.getName()).log(Level.SEVERE, None, ex)
    ...
    def main(self, args: list) -> None:
        ...
        try:
            ...
            Logger.getLogger(RoyMS.class.getName()).log(Level.SEVERE, None, ex2)
