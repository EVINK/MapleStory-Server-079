...
class MapleFitness(MapleEvent):
    ...
    def checkAndMessage(self) -> None:
        ...
        self.msgSchedule = Timer.EventTimer.getInstance().register(_task_1, 90000)
