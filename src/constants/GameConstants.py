"""
GameConstants - Converted from Java source
Original: constants/GameConstants.java
Package: constants
"""
...
class GameConstants:
    ...
    def translated_is飞镖道具(self, itemId: int) -> bool:
        return itemId / 10000 == 207

    def translated_is子弹道具(self, itemId: int) -> bool:
    ...
    def isMonsterCard(self, id: int) -> bool:
        return id / 10000 == 238

    def isSpecialCard(self, id: int) -> bool:
        return id / 1000 >= 2388

    def getCardShortId(self, id: int) -> int:
        return id % 10000
    ...
    def isCustomQuest(self, id: int) -> bool:
        return id > 99999

    def getTaxAmount(self, meso: int) -> int:
        if meso >= 100000000:
    ...
    def EntrustedStoreTax(self, meso: int) -> int:
        if meso >= 100000000:
            return Math.round(0.03 * meso)
        if meso >= 25000000:
            return Math.round(0.025 * meso)
        if meso >= 10000000:
            return Math.round(0.02 * meso)
        if meso >= 5000000:
            return Math.round(0.015 * meso)
        if meso >= 1000000:
            return Math.round(0.009 * meso)
        if meso >= 100000:
            return Math.round(0.004 * meso)
        return 0

    def getSummonAttackDelay(self, id: int) -> int:
        # switch (id):
            # case 2121005:
            # case 2221005:
            # case 2311006:
    ...
    def getAttackDelay(self, id: int) -> int:
        # switch (id):
            # case 4321001:
                return 40
            # case 3121004:
    ...
    def gachaponRareItem(self, id: int) -> int:
        # switch (id):
            # case 1022129:
            # case 3010012:
            # case 3010013:
    ...
    def isDragonItem(self, itemId: int) -> bool:
        # switch (itemId):
            # case 1302059:
            # case 1312031:
            # case 1322052:
    ...
    def isReverseItem(self, itemId: int) -> bool:
        # switch (itemId):
            # case 1002790:
            # case 1002791:
            # case 1002792:
    ...
    def isTimelessItem(self, itemId: int) -> bool:
        # switch (itemId):
            # case 1002776:
            # case 1002777:
            # case 1002778:
    ...
    def isCrushRing(self, itemId: int) -> bool:
        # switch (itemId):
            # case 1048000:
            # case 1048001:
            # case 1048002:
    ...
    def translated_道具佩戴附加经验值(self, itemid: int) -> int:
        # switch (itemid):
            # case 1122017:
                return 10
            # default:
    ...
    def getExpForLevel(self, i: int, itemId: int) -> int:
    ...
    def getMaxLevel(self, itemId: int) -> int:
    ...
    def getStatChance(self) -> int:
        return 25

    @staticmethod
    def getStatFromWeapon(itemid: int) -> Any:
        # switch (itemid):
            # case 1302109:
            # case 1312041:
            # case 1322067:
    ...
    def getXForStat(self, stat: Any) -> int:
        # switch (stat):
            # case 命中:
                return -70
            # case 速度:
    ...
    def getSkillForStat(self, stat: Any) -> int:
        # switch (stat):
            # case 命中:
                return 3221006
            # case 速度:
    ...
    def getSkillBookForSkill(self, skillid: int) -> int:
        return getSkillBook(skillid / 10000)

    def getMountItem(self, sourceid: int) -> int:
        # switch (sourceid):
            # case 5221006:
                return 1932000
            # case 33001001:
    ...
    def isKatara(self, itemId: int) -> bool:
        return itemId / 10000 == 134

    def isDagger(self, itemId: int) -> bool:
    ...
    def getSuccessTablet(self, scrollId: int, level: int) -> int:
    ...
    def getCurseTablet(self, scrollId: int, level: int) -> int:
        # switch (scrollId % 1000 / 100):
            # case 2:
                # switch (level):
                    # case 0:
    ...
    def optionTypeFits(self, optionType: int, itemId: int) -> bool:
        # switch (optionType):
            # case 10:
    ...
    def getExpRate_Quest(self, level: int) -> int:
        return 1

    @staticmethod
    def getCashBlockedMsg(id: int) -> str:
        # switch (id):
            # case 5062000:
    ...
    def isCustomReactItem(self, rid: int, iid: int, original: int) -> bool:
        if rid == 2008006:
            return iid == Calendar.getInstance().get(7) + 4001055
        return iid == original

    def getJobNumber(self, jobz: int) -> int:
        job = jobz % 1000
        if job / 100 == 0:
            return 0
        if job / 10 == 0:
    ...
    def isForceRespawn(self, mapid: int) -> bool:
        # switch (mapid):
            # case 925100100:
                return True
            # default:
    ...
    def canForfeit(self, questid: int) -> bool:
        # switch (questid):
            # case 20000:
            # case 20010:
            # case 20015:
    ...
    def getCustomReactItem(self, rid: int, original: int) -> int:
        if rid == 2008006:
            return Calendar.getInstance().get(7) + 4001055
        return original

    def Summon_Skill_ID_550(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 3121006:
                return True
            # default:
    ...
    def Summon_Skill_ID_500(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 3221005:
            # case 5220002:
                return True
    ...
    def Summon_Skill_ID_450(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 5211002:
                return True
            # default:
    ...
    def Summon_Skill_ID_300(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 2221005:
                return True
            # default:
    ...
    def Summon_Skill_ID_270(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 2121005:
                return True
            # default:
    ...
    def Summon_Skill_ID_250(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 12111004:
                return True
            # default:
    ...
    def Summon_Skill_ID_230(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 2321003:
                return True
            # default:
    ...
    def Summon_Skill_ID_200(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 5211001:
                return True
            # default:
    ...
    def Summon_Skill_ID_150(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 2311006:
                return True
            # default:
    ...
    def Summon_Skill_ID_100(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 3111005:
            # case 3211005:
                return True
    ...
    def Summon_Skill_ID_40(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 11001004:
            # case 12001004:
            # case 13001004:
    ...
    def Novice_Skill(self, skill: int, c: Any, damage: int) -> int:
        # switch (skill):
            # case 1000:
            # case 10001000:
            # case 20001000:
    ...
    def Novice_Skill_skill(self, skill: int) -> bool:
        # switch (skill):
            # case 1000:
            # case 10001000:
            # case 20001000:
    ...
    def Ares_Skill_140(self, skill: int) -> bool:
        # switch (skill):
            # case 21000002:
            # case 21100002:
            # case 21110006:
    ...
    def Ares_Skill_350(self, skill: int) -> bool:
        # switch (skill):
            # case 21100001:
            # case 21110002:
            # case 21110003:
    ...
    def Ares_Skill_800(self, skill: int) -> bool:
        # switch (skill):
            # case 21100004:
            # case 21110004:
            # case 21120005:
    ...
    def Ares_Skill_1500(self, skill: int) -> bool:
        # switch (skill):
            # case 21120006:
                return True
            # default:
    ...
    def Thief_Skill_270(self, skill: int) -> bool:
        # switch (skill):
            # case 15001001:
            # case 15001002:
            # case 15101006:
    ...
    def Thief_Skill_420(self, skill: int) -> bool:
        # switch (skill):
            # case 15101003:
            # case 15111001:
            # case 15111007:
    ...
    def Thief_Skill_650(self, skill: int) -> bool:
        # switch (skill):
            # case 15111003:
                return True
            # default:
    ...
    def Night_Knight_Skill_220(self, skill: int) -> bool:
        # switch (skill):
            # case 14001004:
            # case 14100005:
            # case 14101006:
    ...
    def Wind_Knight_Skill_160(self, skill: int) -> bool:
        # switch (skill):
            # case 13001003:
            # case 13101005:
            # case 13111000:
    ...
    def Wind_Knight_Skill_550(self, skill: int) -> bool:
        # switch (skill):
            # case 13111006:
            # case 13111007:
                return True
    ...
    def Fire_Knight_Skill_140(self, skill: int) -> bool:
        # switch (skill):
            # case 12001003:
            # case 12101002:
            # case 12101006:
    ...
    def Fire_Knight_Skill_500(self, skill: int) -> bool:
        # switch (skill):
            # case 12111003:
                return True
            # default:
    ...
    def Ghost_Knight_Skill_320(self, skill: int) -> bool:
        # switch (skill):
            # case 11001002:
            # case 11001003:
            # case 11101004:
    ...
    def Pirate_Skill_290(self, skill: int) -> bool:
        # switch (skill):
            # case 5001001:
            # case 5001002:
            # case 5001003:
    ...
    def Pirate_Skill_420(self, skill: int) -> bool:
        # switch (skill):
            # case 5101004:
            # case 5121004:
            # case 5211006:
    ...
    def Pirate_Skill_700(self, skill: int) -> bool:
        # switch (skill):
            # case 5111006:
            # case 5121005:
            # case 5220011:
    ...
    def Pirate_Skill_810(self, skill: int) -> bool:
        # switch (skill):
            # case 5121001:
            # case 5221008:
                return True
    ...
    def Pirate_Skill_1200(self, skill: int) -> bool:
        # switch (skill):
            # case 5221003:
                return True
            # default:
    ...
    def Thief_Skill_180(self, skill: int) -> bool:
        # switch (skill):
            # case 4001334:
            # case 4001344:
            # case 4101005:
    ...
    def Thief_Skill_250(self, skill: int) -> bool:
        # switch (skill):
            # case 4211004:
                return True
            # default:
    ...
    def Thief_Skill_500(self, skill: int) -> bool:
        # switch (skill):
            # case 4211002:
            # case 4221001:
            # case 4221007:
    ...
    def Bowman_Skill_180(self, skill: int) -> bool:
        # switch (skill):
            # case 3001005:
            # case 3101005:
            # case 3111004:
    ...
    def Bowman_Skill_260(self, skill: int) -> bool:
        # switch (skill):
            # case 3000001:
            # case 3001004:
            # case 3101003:
    ...
    def Bowman_Skill_850(self, skill: int) -> bool:
        # switch (skill):
            # case 3221001:
                return True
            # default:
    ...
    def Magician_Skill_90(self, skill: int) -> bool:
        # switch (skill):
            # case 2001004:
            # case 2001005:
            # case 2301005:
    ...
    def Magician_Skill_180(self, skill: int) -> bool:
        # switch (skill):
            # case 2101004:
            # case 2111002:
            # case 2111006:
    ...
    def Magician_Skill_240(self, skill: int) -> bool:
        # switch (skill):
            # case 2121006:
            # case 2201005:
            # case 2301002:
    ...
    def Magician_Skill_670(self, skill: int) -> bool:
        # switch (skill):
            # case 2121001:
            # case 2121007:
            # case 2221001:
    ...
    def Warrior_Skill_900(self, skill: int) -> bool:
        # switch (skill):
            # case 1221011:
                return True
            # default:
    ...
    def Warrior_Skill_550(self, skill: int) -> bool:
        # switch (skill):
            # case 1221009:
                return True
            # default:
    ...
    def Warrior_Skill_450(self, skill: int) -> bool:
        # switch (skill):
            # case 1001004:
            # case 1001005:
            # case 1100002:
    ...
    def Warrior_Skill_2000(self, skill: int) -> bool:
        # switch (skill):
            # case 1111003:
            # case 1111004:
            # case 1111005:
    ...
    def No_Mob(self, MobID: int) -> bool:
        # switch (MobID):
            # case 8220003:
            # case 8220004:
            # case 8220005:
    ...
    def translated_不检测技能(self, SkillID: int) -> bool:
        # switch (SkillID):
            # case 1111008:
            # case 1121001:
            # case 1121006:
    ...
    def isMarriageRing(self, itemId: int) -> bool:
        # switch (itemId):
            # case 1112013:
            # case 1112300:
            # case 1112301:
    ...
    def isElseSkill(self, id: int) -> bool:
        # switch (id):
            # case 1009:
            # case 1020:
            # case 4211006:
    ...
    def getFishingTime(self, vip: bool, gm: bool) -> int:
        ...
        FishingVIPSJ = Fishing.getFishingVIPSJ()
        FishingSJ = Fishing.getFishingSJ()
        return gm ? 1000 : (vip ? FishingVIPSJ : FishingSJ)

    def translated_分解的矿石(self) -> int:
        s = Randomizer.nextInt(22)
        # switch (s):
            # case 1:
                return 4004000
            # case 2:
    ...
    def isThrowingStar(self, itemId: int) -> bool:
        return itemId / 10000 == 207

    def isBullet(self, itemId: int) -> bool:
        return itemId / 10000 == 233
